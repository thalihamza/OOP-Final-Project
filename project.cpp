...
{
	char usertype;
	cout << "ENTER THE 'S' FOR STUDENT & ENTER 'L' FOR LIBRARIAN." << endl;
	cin >> usertype;
   ...
   protected:
		...
		public:
			...
			void inputStudent()
			{
				...
				if (!fin)
				{
					cout << "ERROR READING USER FILE!" << endl;
				}
				else
				{
					string username, other_password;
					string garbagevalue;
